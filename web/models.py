...
class Product(models.Model):
    ...
    product_image1 = VersatileImageField(
        "Image",
    ...
    product_image2 = VersatileImageField(
        "Image",
        upload_to="image/testimagemodel/",
        ppoi_field="ppoi",
        null=True,
    ...
    product_image3 = VersatileImageField(
        "Image",
        upload_to="image/testimagemodel/",
        ppoi_field="ppoi",
        null=True,
    ...
    product_image4 = VersatileImageField(
        "Image",
        upload_to="image/testimagemodel/",
        ppoi_field="ppoi",
        null=True,
...
class Blog(models.Model):
    ...
    blog_image = VersatileImageField(
        "Image", upload_to="image/testimagemodel/", ppoi_field="ppoi"
    )
    ppoi = PPOIField("Image PPOI")
